...
public class LineGraphView extends View
{
	...
	private int WIDTH = 400; //no longer final (allows width to be overridden in constructor)
	private int HEIGHT = 400; //no longer final (allows height to be overridden in constructor)
	 ...
	 * @param width The width of the linegraphview
	 * @param height The height of the linegraphview
	 */
	public LineGraphView(Context context, int dataWidth, List<String> labels, int width, int height) {
		super(context);
		WIDTH = width;
		HEIGHT = height;
